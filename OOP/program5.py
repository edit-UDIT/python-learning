#so here in this programm , instead of writing a bunch of messy custom functions like add_pay() or get_specialization_length() 
#we used dunder methods which let your custom objects plug straight into Python's native syntax (+, len(), print() and much more ) 
#It cleans up your code massively and makes everything look and feel like built-in Python!
#Stay spidey :3
